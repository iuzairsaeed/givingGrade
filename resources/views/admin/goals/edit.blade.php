                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$record->actual_target}}" class="form-control border-primary @error('target') is-invalid @enderror" name="target" placeholder="Enter Current Target">
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select name="charity" id="user" value="{{old('user')}}" class="form-control border-primary" >
                                    <option value="{{$record->charity->id}}" selected>{{$record->charity->title}}</option>
                                </select>
                            </div>
